...
**
** Created: Thu Apr 14 10:01:53 2011
...
static const char qt_meta_stringdata_SvgView[] = {
    "SvgView\0\0s\0updateSvg(QString)\0"
};

const QMetaObject SvgView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SvgView,
...
int SvgView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: updateSvg((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
